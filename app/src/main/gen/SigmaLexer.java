...
public class SigmaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CLASS", "IF", "ELSE", "WHILE", "RETURN", "FINAL", "NULL", "PRIMITIVE_TYPE", 
			"STRING_TYPE", "VOID", "POWER", "MULTIPLICATIVE", "ADDITIVE", "RELATIONAL", 
			"LOGICAL", "NOT", "ASSIGN", "MINUS", "PLUS", "LPAREN", "RPAREN", "LBRACE", 
			"RBRACE", "SEMI", "COMMA", "DOT", "BOOLEAN", "LETTER", "DIGIT", "IDENTIFIER", 
			"INTEGER", "FLOAT", "STRING", "WS", "LINE_COMMENT", "BLOCK_COMMENT"
		};
	}
